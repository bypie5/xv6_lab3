...
80100394:	e8 b7 02 00 00       	call   80100650 <cprintf>
  cprintf("\n");
80100399:	c7 04 24 3f 76 10 80 	movl   $0x8010763f,(%esp)
...
80100bef:	e8 bc 5f 00 00       	call   80106bb0 <copyout>
...
80100c01:	e8 1a 5d 00 00       	call   80106920 <freevm>
  return -1;
...
80100c10:	e8 4b 1f 00 00       	call   80102b60 <end_op>
    cprintf("exec: fail\n");
80100c15:	c7 04 24 41 6d 10 80 	movl   $0x80106d41,(%esp)
...
80100c6d:	89 95 60 ff ff ff    	mov    %edx,-0xa0(%ebp)
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100c73:	e8 38 5f 00 00       	call   80106bb0 <copyout>
...
80100ce7:	8b 47 18             	mov    0x18(%edi),%eax
  curproc->pgdir = pgdir;
...
80100cff:	e8 9c 58 00 00       	call   801065a0 <switchuvm>
  freevm(oldpgdir);
80100d04:	89 34 24             	mov    %esi,(%esp)
80100d07:	e8 14 5c 00 00       	call   80106920 <freevm>
  return 0;
...
80100d26:	c7 44 24 04 4d 6d 10 	movl   $0x80106d4d,0x4(%esp)
80100d2d:	80 
...
80100de6:	c3                   	ret    
    panic("filedup");
80100de7:	c7 04 24 54 6d 10 80 	movl   $0x80106d54,(%esp)
...
80100ea7:	e9 b4 1c 00 00       	jmp    80102b60 <end_op>
    panic("fileclose");
80100eac:	c7 04 24 5c 6d 10 80 	movl   $0x80106d5c,(%esp)
...
80100f95:	eb d8                	jmp    80100f6f <fileread+0x5f>
  panic("fileread");
80100f97:	c7 04 24 66 6d 10 80 	movl   $0x80106d66,(%esp)
...
801010ac:	e9 1f 22 00 00       	jmp    801032d0 <pipewrite>
        panic("short filewrite");
801010b1:	c7 04 24 6f 6d 10 80 	movl   $0x80106d6f,(%esp)
801010b8:	e8 a3 f2 ff ff       	call   80100360 <panic>
  panic("filewrite");
801010bd:	c7 04 24 75 6d 10 80 	movl   $0x80106d75,(%esp)
...
80101175:	c7 04 24 7f 6d 10 80 	movl   $0x80106d7f,(%esp)
...
8010129d:	c7 04 24 95 6d 10 80 	movl   $0x80106d95,(%esp)
...
80101355:	eb 93                	jmp    801012ea <bmap+0x3a>
  panic("bmap: out of range");
80101357:	c7 04 24 a5 6d 10 80 	movl   $0x80106da5,(%esp)
...
80101439:	c7 04 24 b8 6d 10 80 	movl   $0x80106db8,(%esp)
...
8010145c:	c7 44 24 04 cb 6d 10 	movl   $0x80106dcb,0x4(%esp)
80101463:	80 
...
80101479:	c7 44 24 04 d2 6d 10 	movl   $0x80106dd2,0x4(%esp)
80101480:	80 
...
801014a6:	c7 04 24 38 6e 10 80 	movl   $0x80106e38,(%esp)
...
801015c1:	c7 04 24 d8 6d 10 80 	movl   $0x80106dd8,(%esp)
...
80101744:	0f 85 76 ff ff ff    	jne    801016c0 <ilock+0x30>
      panic("ilock: no type");
8010174a:	c7 04 24 f0 6d 10 80 	movl   $0x80106df0,(%esp)
80101751:	e8 0a ec ff ff       	call   80100360 <panic>
    panic("ilock");
80101756:	c7 04 24 ea 6d 10 80 	movl   $0x80106dea,(%esp)
...
8010179e:	e9 1d 28 00 00       	jmp    80103fc0 <releasesleep>
    panic("iunlock");
801017a3:	c7 04 24 ff 6d 10 80 	movl   $0x80106dff,(%esp)
...
80101c41:	c3                   	ret    
      panic("dirlookup read");
80101c42:	c7 04 24 19 6e 10 80 	movl   $0x80106e19,(%esp)
80101c49:	e8 12 e7 ff ff       	call   80100360 <panic>
    panic("dirlookup not DIR");
80101c4e:	c7 04 24 07 6e 10 80 	movl   $0x80106e07,(%esp)
...
80101ec3:	eb e9                	jmp    80101eae <dirlink+0xae>
      panic("dirlink read");
80101ec5:	c7 04 24 28 6e 10 80 	movl   $0x80106e28,(%esp)
80101ecc:	e8 8f e4 ff ff       	call   80100360 <panic>
    panic("dirlink");
80101ed1:	c7 04 24 26 74 10 80 	movl   $0x80107426,(%esp)
...
80101fbf:	c7 04 24 94 6e 10 80 	movl   $0x80106e94,(%esp)
80101fc6:	e8 95 e3 ff ff       	call   80100360 <panic>
    panic("idestart");
80101fcb:	c7 04 24 8b 6e 10 80 	movl   $0x80106e8b,(%esp)
...
80101fe6:	c7 44 24 04 a6 6e 10 	movl   $0x80106ea6,0x4(%esp)
80101fed:	80 
...
801021b9:	eb bb                	jmp    80102176 <iderw+0x76>
    panic("iderw: buf not locked");
801021bb:	c7 04 24 aa 6e 10 80 	movl   $0x80106eaa,(%esp)
801021c2:	e8 99 e1 ff ff       	call   80100360 <panic>
    panic("iderw: ide disk 1 not present");
801021c7:	c7 04 24 d5 6e 10 80 	movl   $0x80106ed5,(%esp)
801021ce:	e8 8d e1 ff ff       	call   80100360 <panic>
    panic("iderw: nothing to do");
801021d3:	c7 04 24 c0 6e 10 80 	movl   $0x80106ec0,(%esp)
...
80102228:	c7 04 24 f4 6e 10 80 	movl   $0x80106ef4,(%esp)
...
8010235c:	eb bb                	jmp    80102319 <kfree+0x49>
    panic("kfree");
8010235e:	c7 04 24 26 6f 10 80 	movl   $0x80106f26,(%esp)
...
801023cb:	c7 44 24 04 2c 6f 10 	movl   $0x80106f2c,0x4(%esp)
801023d2:	80 
...
80102514:	0f b6 81 60 70 10 80 	movzbl -0x7fef8fa0(%ecx),%eax
...
80102548:	0f b6 91 60 70 10 80 	movzbl -0x7fef8fa0(%ecx),%edx
  shift ^= togglecode[data];
8010254f:	0f b6 81 60 6f 10 80 	movzbl -0x7fef90a0(%ecx),%eax
  shift |= shiftcode[data];
...
8010255f:	8b 04 85 40 6f 10 80 	mov    -0x7fef90c0(,%eax,4),%eax
  shift ^= togglecode[data];
...
80102a5b:	c7 44 24 04 60 71 10 	movl   $0x80107160,0x4(%esp)
80102a62:	80 
...
80102c82:	c3                   	ret    
    panic("log.committing");
80102c83:	c7 04 24 64 71 10 80 	movl   $0x80107164,(%esp)
...
80102d3d:	8d 76 00             	lea    0x0(%esi),%esi
    panic("too big a transaction");
80102d40:	c7 04 24 73 71 10 80 	movl   $0x80107173,(%esp)
80102d47:	e8 14 d6 ff ff       	call   80100360 <panic>
    panic("log_write outside of trans");
80102d4c:	c7 04 24 89 71 10 80 	movl   $0x80107189,(%esp)
...
80102d77:	c7 04 24 a4 71 10 80 	movl   $0x801071a4,(%esp)
...
80102e25:	e8 16 3e 00 00       	call   80106c40 <shminit>
  tvinit();        // trap vectors
...
80102f1f:	00 
80102f20:	c7 44 24 04 b8 71 10 	movl   $0x801071b8,0x4(%esp)
80102f27:	80 
...
80102fda:	00 
80102fdb:	c7 44 24 04 bd 71 10 	movl   $0x801071bd,0x4(%esp)
80102fe2:	80 
...
8010306c:	ff 24 8d fc 71 10 80 	jmp    *-0x7fef8e04(,%ecx,4)
80103073:	90                   	nop
...
801030f7:	0f 85 c5 fe ff ff    	jne    80102fc2 <mpinit+0x52>
    panic("Expect to run on an SMP");
801030fd:	c7 04 24 c2 71 10 80 	movl   $0x801071c2,(%esp)
...
80103118:	eb e3                	jmp    801030fd <mpinit+0x18d>
    panic("Didn't find a suitable machine");
8010311a:	c7 04 24 dc 71 10 80 	movl   $0x801071dc,(%esp)
...
801031bf:	c7 44 24 04 10 72 10 	movl   $0x80107210,0x4(%esp)
801031c6:	80 
...
801035c6:	c7 44 24 04 15 72 10 	movl   $0x80107215,0x4(%esp)
801035cd:	80 
...
8010363a:	c7 04 24 1c 72 10 80 	movl   $0x8010721c,(%esp)
80103641:	e8 1a cd ff ff       	call   80100360 <panic>
    panic("mycpu called with interrupts enabled\n");
80103646:	c7 04 24 f8 72 10 80 	movl   $0x801072f8,(%esp)
...
80103762:	00 
80103763:	c7 44 24 04 45 72 10 	movl   $0x80107245,0x4(%esp)
8010376a:	80 
8010376b:	89 04 24             	mov    %eax,(%esp)
8010376e:	e8 cd 0c 00 00       	call   80104440 <safestrcpy>
  p->cwd = namei("/");
80103773:	c7 04 24 4e 72 10 80 	movl   $0x8010724e,(%esp)
...
801037a7:	c7 04 24 2c 72 10 80 	movl   $0x8010722c,(%esp)
...
8010385e:	e8 1d 32 00 00       	call   80106a80 <copyuvm>
...
80103a4e:	c7 04 24 50 72 10 80 	movl   $0x80107250,(%esp)
80103a55:	e8 06 c9 ff ff       	call   80100360 <panic>
    panic("sched interruptible");
80103a5a:	c7 04 24 7c 72 10 80 	movl   $0x8010727c,(%esp)
80103a61:	e8 fa c8 ff ff       	call   80100360 <panic>
    panic("sched running");
80103a66:	c7 04 24 6e 72 10 80 	movl   $0x8010726e,(%esp)
80103a6d:	e8 ee c8 ff ff       	call   80100360 <panic>
    panic("sched locks");
80103a72:	c7 04 24 62 72 10 80 	movl   $0x80107262,(%esp)
...
80103b76:	e8 65 fe ff ff       	call   801039e0 <sched>
  panic("zombie exit");
80103b7b:	c7 04 24 9d 72 10 80 	movl   $0x8010729d,(%esp)
80103b82:	e8 d9 c7 ff ff       	call   80100360 <panic>
    panic("init exiting");
80103b87:	c7 04 24 90 72 10 80 	movl   $0x80107290,(%esp)
...
80103c6e:	c7 04 24 af 72 10 80 	movl   $0x801072af,(%esp)
80103c75:	e8 e6 c6 ff ff       	call   80100360 <panic>
    panic("sleep");
80103c7a:	c7 04 24 a9 72 10 80 	movl   $0x801072a9,(%esp)
...
80103e64:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    cprintf("\n");
80103e68:	c7 04 24 3f 76 10 80 	movl   $0x8010763f,(%esp)
...
80103e8a:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
80103e8d:	ba c0 72 10 80       	mov    $0x801072c0,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80103e92:	77 11                	ja     80103ea5 <procdump+0x55>
80103e94:	8b 14 85 20 73 10 80 	mov    -0x7fef8ce0(,%eax,4),%edx
      state = "???";
80103e9b:	b8 c0 72 10 80       	mov    $0x801072c0,%eax
...
80103eb0:	c7 04 24 c4 72 10 80 	movl   $0x801072c4,(%esp)
...
80103ef9:	c7 04 24 01 6d 10 80 	movl   $0x80106d01,(%esp)
...
80103f2a:	c7 44 24 04 38 73 10 	movl   $0x80107338,0x4(%esp)
80103f31:	80 
...
80104187:	eb ac                	jmp    80104135 <acquire+0x15>
    panic("acquire");
80104189:	c7 04 24 43 73 10 80 	movl   $0x80107343,(%esp)
...
801041e9:	c3                   	ret    
    panic("popcli");
801041ea:	c7 04 24 62 73 10 80 	movl   $0x80107362,(%esp)
801041f1:	e8 6a c1 ff ff       	call   80100360 <panic>
    panic("popcli - interruptible");
801041f6:	c7 04 24 4b 73 10 80 	movl   $0x8010734b,(%esp)
...
8010421f:	75 0f                	jne    80104230 <release+0x20>
    panic("release");
80104221:	c7 04 24 69 73 10 80 	movl   $0x80107369,(%esp)
...
8010461d:	8b 14 85 a0 73 10 80 	mov    -0x7fef8c60(,%eax,4),%edx
...
80104646:	c7 04 24 71 73 10 80 	movl   $0x80107371,(%esp)
...
801047d0:	c7 44 24 04 1c 74 10 	movl   $0x8010741c,0x4(%esp)
801047d7:	80 
...
801047eb:	c7 44 24 04 1b 74 10 	movl   $0x8010741b,0x4(%esp)
801047f2:	80 
...
80104801:	79 89                	jns    8010478c <create+0xdc>
      panic("create dots");
80104803:	c7 04 24 0f 74 10 80 	movl   $0x8010740f,(%esp)
8010480a:	e8 51 bb ff ff       	call   80100360 <panic>
    panic("create: dirlink");
8010480f:	c7 04 24 1e 74 10 80 	movl   $0x8010741e,(%esp)
80104816:	e8 45 bb ff ff       	call   80100360 <panic>
    panic("create: ialloc");
8010481b:	c7 04 24 00 74 10 80 	movl   $0x80107400,(%esp)
...
80104bc1:	c7 44 24 04 1c 74 10 	movl   $0x8010741c,0x4(%esp)
80104bc8:	80 
...
80104bd9:	c7 44 24 04 1b 74 10 	movl   $0x8010741b,0x4(%esp)
80104be0:	80 
...
80104d2d:	c7 04 24 40 74 10 80 	movl   $0x80107440,(%esp)
80104d34:	e8 27 b6 ff ff       	call   80100360 <panic>
    panic("unlink: writei");
80104d39:	c7 04 24 52 74 10 80 	movl   $0x80107452,(%esp)
80104d40:	e8 1b b6 ff ff       	call   80100360 <panic>
    panic("unlink: nlink < 1");
80104d45:	c7 04 24 2e 74 10 80 	movl   $0x8010742e,(%esp)
...
801051f9:	e8 a2 1a 00 00       	call   80106ca0 <shm_open>
}
801051fe:	c9                   	leave  
801051ff:	c3                   	ret    
    return -1;
...
80105233:	e8 78 1a 00 00       	call   80106cb0 <shm_close>
}
80105238:	c9                   	leave  
80105239:	c3                   	ret    
...
80105479:	c7 44 24 04 61 74 10 	movl   $0x80107461,0x4(%esp)
80105480:	80 
...
80105510:	ff 24 85 08 75 10 80 	jmp    *-0x7fef8af8(,%eax,4)
80105517:	90                   	nop
    lapiceoi();
    break;
...
80105583:	c7 04 24 c4 74 10 80 	movl   $0x801074c4,(%esp)
...
8010567c:	c7 04 24 6c 74 10 80 	movl   $0x8010746c,(%esp)
...
8010573a:	c7 04 24 90 74 10 80 	movl   $0x80107490,(%esp)
80105741:	89 44 24 04          	mov    %eax,0x4(%esp)
80105745:	e8 06 af ff ff       	call   80100650 <cprintf>
      panic("trap");
8010574a:	c7 04 24 66 74 10 80 	movl   $0x80107466,(%esp)
...
80105847:	00 
  for(p="xv6...\n"; *p; p++)
80105848:	bb 88 75 10 80       	mov    $0x80107588,%ebx
  ioapicenable(IRQ_COM1, 0);
...
8010642a:	c3                   	ret    
        panic("kfree");
8010642b:	c7 04 24 26 6f 10 80 	movl   $0x80106f26,(%esp)
...
80106571:	c3                   	ret    
      panic("remap");
80106572:	c7 04 24 90 75 10 80 	movl   $0x80107590,(%esp)
...
80106681:	c7 04 24 96 75 10 80 	movl   $0x80107596,(%esp)
80106688:	e8 d3 9c ff ff       	call   80100360 <panic>
    panic("switchuvm: no pgdir");
8010668d:	c7 04 24 c1 75 10 80 	movl   $0x801075c1,(%esp)
80106694:	e8 c7 9c ff ff       	call   80100360 <panic>
    panic("switchuvm: no kstack");
80106699:	c7 04 24 ac 75 10 80 	movl   $0x801075ac,(%esp)
...
8010672e:	c7 04 24 d5 75 10 80 	movl   $0x801075d5,(%esp)
...
801067e2:	c7 04 24 ef 75 10 80 	movl   $0x801075ef,(%esp)
801067e9:	e8 72 9b ff ff       	call   80100360 <panic>
    panic("loaduvm: addr must be page aligned");
801067ee:	c7 04 24 90 76 10 80 	movl   $0x80107690,(%esp)
...
80106892:	c7 04 24 0d 76 10 80 	movl   $0x8010760d,(%esp)
...
801068c0:	c7 04 24 25 76 10 80 	movl   $0x80107625,(%esp)
...
80106983:	e9 48 b9 ff ff       	jmp    801022d0 <kfree>
    panic("freevm: no pgdir");
80106988:	c7 04 24 41 76 10 80 	movl   $0x80107641,(%esp)
...
80106a6b:	c3                   	ret    
    panic("clearpteu");
80106a6c:	c7 04 24 52 76 10 80 	movl   $0x80107652,(%esp)
...
80106a93:	0f 84 ba 00 00 00    	je     80106b53 <copyuvm+0xd3>
    return 0;
...
80106a9e:	0f 84 a4 00 00 00    	je     80106b48 <copyuvm+0xc8>
...
80106aec:	78 45                	js     80106b33 <copyuvm+0xb3>
  for(i = 0; i < sz; i += PGSIZE){
80106aee:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106af4:	39 5d 0c             	cmp    %ebx,0xc(%ebp)
80106af7:	76 4f                	jbe    80106b48 <copyuvm+0xc8>
...
80106b07:	74 5a                	je     80106b63 <copyuvm+0xe3>
    if(!(*pte & PTE_P))
80106b09:	8b 30                	mov    (%eax),%esi
80106b0b:	f7 c6 01 00 00 00    	test   $0x1,%esi
80106b11:	74 44                	je     80106b57 <copyuvm+0xd7>
    pa = PTE_ADDR(*pte);
80106b13:	89 f7                	mov    %esi,%edi
    flags = PTE_FLAGS(*pte);
80106b15:	81 e6 ff 0f 00 00    	and    $0xfff,%esi
80106b1b:	89 75 e4             	mov    %esi,-0x1c(%ebp)
    pa = PTE_ADDR(*pte);
80106b1e:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    if((mem = kalloc()) == 0)
80106b24:	e8 57 b9 ff ff       	call   80102480 <kalloc>
80106b29:	85 c0                	test   %eax,%eax
80106b2b:	89 c6                	mov    %eax,%esi
80106b2d:	0f 85 75 ff ff ff    	jne    80106aa8 <copyuvm+0x28>
      goto bad;
	}
  return d;
...
80106b39:	e8 e2 fd ff ff       	call   80106920 <freevm>
  return 0;
80106b3e:	31 c0                	xor    %eax,%eax
}
80106b40:	83 c4 2c             	add    $0x2c,%esp
80106b43:	5b                   	pop    %ebx
80106b44:	5e                   	pop    %esi
80106b45:	5f                   	pop    %edi
80106b46:	5d                   	pop    %ebp
...
80106b55:	eb e9                	jmp    80106b40 <copyuvm+0xc0>
      panic("copyuvm: page not present");
80106b57:	c7 04 24 76 76 10 80 	movl   $0x80107676,(%esp)
80106b5e:	e8 fd 97 ff ff       	call   80100360 <panic>
      panic("copyuvm: pte should exist");
80106b63:	c7 04 24 5c 76 10 80 	movl   $0x8010765c,(%esp)
80106b6a:	e8 f1 97 ff ff       	call   80100360 <panic>
80106b6f:	90                   	nop
...
80106b7e:	e8 8d f7 ff ff       	call   80106310 <walkpgdir>
  if((*pte & PTE_P) == 0)
...
80106bec:	e8 0f d7 ff ff       	call   80104300 <memmove>
    len -= n;
    buf += n;
...
80106c46:	c7 44 24 04 b4 76 10 	movl   $0x801076b4,0x4(%esp)
80106c4d:	80 
80106c4e:	c7 04 24 c0 55 11 80 	movl   $0x801155c0,(%esp)
80106c55:	e8 d6 d3 ff ff       	call   80104030 <initlock>
  acquire(&(shm_table.lock));
80106c5a:	c7 04 24 c0 55 11 80 	movl   $0x801155c0,(%esp)
80106c61:	e8 ba d4 ff ff       	call   80104120 <acquire>
80106c66:	b8 f4 55 11 80       	mov    $0x801155f4,%eax
80106c6b:	90                   	nop
80106c6c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  for (i = 0; i< 64; i++) {
    shm_table.shm_pages[i].id =0;
80106c70:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
80106c76:	83 c0 0c             	add    $0xc,%eax
    shm_table.shm_pages[i].frame =0;
80106c79:	c7 40 f8 00 00 00 00 	movl   $0x0,-0x8(%eax)
    shm_table.shm_pages[i].refcnt =0;
80106c80:	c7 40 fc 00 00 00 00 	movl   $0x0,-0x4(%eax)
  for (i = 0; i< 64; i++) {
80106c87:	3d f4 58 11 80       	cmp    $0x801158f4,%eax
80106c8c:	75 e2                	jne    80106c70 <shminit+0x30>
  }
  release(&(shm_table.lock));
80106c8e:	c7 04 24 c0 55 11 80 	movl   $0x801155c0,(%esp)
80106c95:	e8 76 d5 ff ff       	call   80104210 <release>
}
80106c9a:	c9                   	leave  
80106c9b:	c3                   	ret    
